...
all_attribute_keys = telemetry_keys + attributes_keys + shared_attributes_keys + machine_attributes_keys + ph_attributes_keys + turbidity_attributes_keys + radar_attributes_keys + alarm_attributes_keys + gps_attributes_keys
