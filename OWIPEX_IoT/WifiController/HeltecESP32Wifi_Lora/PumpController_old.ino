...
constexpr char PUMP_RELAY_ATTR[] = "co2Relay";
constexpr char SEC_RELAY_ATTR[] = "heatingRelay";
...
void loop() {
  ...
  if (millis() - previousDataSend > telemetrySendInterval) {
    ...
    tb.sendTelemetryInt("pressure", random(10, 12));  // Replace with your temperature sensor reading
